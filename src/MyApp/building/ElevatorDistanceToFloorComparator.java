...
class ElevatorStatusDistanceToFloorComparator implements Comparator<ElevatorStatus> {
     ...
     */
    ElevatorStatusDistanceToFloorComparator(final boolean goingUp, final Floor floor) {
     ...
     */
    @Override
    public int compare(final ElevatorStatus o1, final ElevatorStatus o2) { // ASC
        // queue count
        ...
        final double distanceToSrcElevator1 = Math.abs(Math.abs(o1.getYPosition() + o1.getActualDirection() * o1.getBrakeDistance()) - floor.getYPosition());
        final double distanceToSrcElevator2 = Math.abs(Math.abs(o2.getYPosition() + o2.getActualDirection() * o2.getBrakeDistance()) - floor.getYPosition());
